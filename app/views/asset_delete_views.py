...
class Asset_delete_View(DeleteView):
    ...
    def get(self,request,pk):
        ...
        return render(request, 'datas_delete.html',{'asset':asset,'form':form})

    def get_success_url(self):
        return reverse('app:Asset')


class Asset_type_delete_View(DeleteView):
...
class Asset_category_delete_View(DeleteView):
